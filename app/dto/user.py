...
class UserDTO:
    ...
    def create_user(uid: str, password: str, name: str, gender: str, birth: datetime, phone: str) -> 'UserDTO':
        ...
        dup_user_id = User.query.filter_by(uid=uid).first()
        dup_phone = User.query.filter_by(phone=phone).first()
